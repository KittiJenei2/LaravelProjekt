...
<div>
    ...
    <a href="<?php echo e(route('makers.create')); ?>"><button><i class="fa fa-new" title="Uj"></i>Új</button></a></div>
    <?php $__currentLoopData = $makers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $maker): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="row <?php echo e($loop->iteration % 2 == 0 ? 'even' : 'odd'); ?>">
            ...
            <div class="right">
                <div class="col"><a href="<?php echo e(route('makers.show', $maker->id)); ?>"><button><i class="fa fa-binoculars" title="Mutat"></i>Mutat</button></a></div>
                <!-- Bejelentkezett felhasználó ellenőrzése, csak ha a breeze csomagot telepítettük -->
                    <div class="col"><a href="<?php echo e(route('makers.edit', $maker->id)); ?>"><button><i class="fa fa-edit edit" title="Módosít"></i>Módosít</button></a></div>
                    <div class="col">
